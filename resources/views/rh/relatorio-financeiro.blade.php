...
@section('title', 'RH - Relatório Financeiro')
...
@section('sidebar')
    ...
    <a href="/rh/relatorios" class="nav-link active"><i class="bi bi-file-earmark-bar-graph"></i> Relatórios</a>
@endsection
...
<div class="card mb-4">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="/rh/relatorios" class="btn btn-outline-secondary btn-sm">
            <i class="bi bi-arrow-left me-1"></i> Voltar
        </a>
    </div>
    <div class="card-body">
        <form method="GET" action="/rh/relatorio-financeiro" class="row g-3 align-items-end">
            <div class="col-md-2">
            ...
            <div class="col-md-3 d-flex gap-2">
                ...
                <a href="/rh/relatorio-financeiro/exportar-excel?ano={{ $ano }}&mes_inicio={{ $mesInicio }}&mes_fim={{ $mesFim }}&unidade_id={{ $unidadeId }}" class="btn btn-success btn-sm" title="Exportar Excel">
