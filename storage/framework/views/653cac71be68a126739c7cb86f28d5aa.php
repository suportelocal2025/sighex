        ...
        <div class="card p-3">
            <div class="row align-items-center">
                ...
                <div class="col-md-2">
                    ...
                    <h6 class="mb-0"><?php echo e($escala->data_envio ? date('d/m/Y H:i', strtotime($escala->data_envio)) : '-'); ?></h6>
                </div>
                <?php if($escala->data_aprovacao): ?>
                <div class="col-md-2">
                    <small class="text-muted">Data de Aprovação</small>
                    <h6 class="mb-0"><?php echo e(date('d/m/Y H:i', strtotime($escala->data_aprovacao))); ?></h6>
                </div>
                <?php endif; ?>
                <?php if($escala->status === 'executada' && $escala->valor_executado): ?>
                <div class="col-md-2">
                    <small class="text-muted">Valor Executado</small>
                    <h6 class="mb-0 text-success">R$ <?php echo e(number_format($escala->valor_executado, 2, ',', '.')); ?></h6>
                </div>
                <?php endif; ?>
            ...
            <div class="row mt-2">
                <div class="col-12">
                    ...
                    <span class="text-danger"><?php echo e($escala->motivo_rejeicao); ?></span>
                </div>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="card">
            ...
            <div class="table-responsive">
                <table class="table table-sm">
                    ...
                    <tbody>
                        <?php
                            $resumo = $alocacoes->groupBy(fn($a) => $a->servidor_id . '_' . ($a->modulo_id ?? 0))->map(function($group) use ($servidores) {
                                $primeiro = $group->first();
                                $servidor = $servidores->firstWhere('servidor_id', $primeiro->servidor_id);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/rh/detalhar-escala.blade.php ENDPATH**/ ?>