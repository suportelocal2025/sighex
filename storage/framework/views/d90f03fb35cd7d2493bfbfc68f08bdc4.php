<?php $__env->startSection('title', 'Diretor - Escala Mensal'); ?>
<?php $__env->startSection('header', 'Escala Mensal ' . str_pad($mes, 2, '0', STR_PAD_LEFT) . '/' . $ano); ?>
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1 fw-bold text-dark">
            <i class="bi bi-calendar3 me-2"></i>Escala de <?php echo e($mesNome); ?>/<?php echo e($ano); ?>

        </h4>
        <p class="text-muted mb-0 small"><?php echo e($unidade->nome ?? 'Unidade não definida'); ?></p>
    </div>
        ...
        <form method="GET" action="/diretor/escala-mensal" class="d-flex gap-2">
            <select name="mes" class="form-select form-select-sm" style="width:130px;">
                <?php $__currentLoopData = $meses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($i + 1); ?>" <?php echo e($i + 1 == $mes ? 'selected' : ''); ?>><?php echo e($m); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            <select name="ano" class="form-select form-select-sm" style="width:90px;">
                <?php for($a = date('Y') - 1; $a <= date('Y') + 1; $a++): ?>
                    <option value="<?php echo e($a); ?>" <?php echo e($a == $ano ? 'selected' : ''); ?>><?php echo e($a); ?></option>
                <?php endfor; ?>
            </select>
            <button type="submit" class="btn btn-sm btn-primary">Carregar</button>
        </form>
        <span class="badge bg-<?php echo e($escala->status === 'rascunho' ? 'secondary' : ($escala->status === 'pendente' ? 'warning' : ($escala->status === 'aprovada' ? 'success' : ($escala->status === 'rejeitada' ? 'danger' : 'info')))); ?>">
...
<div class="alert alert-danger border-0 mb-4 d-flex align-items-center justify-content-between">
    <div>
        ...
        <strong>Escala Rejeitada:</strong> <?php echo e($escala->motivo_rejeicao); ?>
        ...
        <div class="row g-3 align-items-center">
            <div class="col-md-4">
                ...
                <select id="equipeSelect" class="form-select">
                    ...
                    <?php $__currentLoopData = $equipes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-md-8">
                <div class="alert alert-info mb-0 py-2">
                    ...
                    <strong>Modo Visualização:</strong> Esta escala está com status <strong><?php echo e(ucfirst($escala->status)); ?></strong> e não pode ser editada.
                </div>
            </div>
        </div>
    </div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white d-flex justify-content-between align-items-center py-2 border-0">
        ...
        <div>
            <a href="/diretor/escala/imprimir-mural?mes=<?php echo e($mes); ?>&ano=<?php echo e($ano); ?>" target="_blank" class="btn btn-outline-secondary btn-sm me-2">
            ...
            <form method="POST" action="/diretor/enviar-aprovacao" class="d-inline" onsubmit="return confirm('Enviar escala para aprovação?')">
                ...
                <button type="submit" class="btn btn-success btn-sm" id="btnEnviar" style="display:none;">
                    <i class="bi bi-send me-1"></i> <?php echo e($escala->status === 'rejeitada' ? 'Re-Enviar para Aprovação' : 'Enviar para Aprovação'); ?>
            ...
            <thead class="sticky-top bg-white">
                <tr>
                    ...
                    <?php for($d = 1; $d <= $diasNoMes; $d++): ?>
                        <?php $info = $diasInfo[$d]; ?>
                        <th class="text-center bg-light text-muted px-1" style="min-width:34px;" title="<?php echo e($info['nomeDia']); ?>, dia <?php echo e($d); ?>">
                            <small class="d-block text-uppercase" style="font-size:0.6rem;"><?php echo e(substr($info['nomeDia'], 0, 3)); ?></small>
                            <?php echo e($d); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="espelharModulo" class="form-select form-select-sm">
                                        ...
                                        <?php $__currentLoopData = $modulos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($mod->id); ?>"><?php echo e($mod->nome); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select id="espelharEquipe" class="form-select form-select-sm">
                                        ...
                                        <?php $__currentLoopData = $equipes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($eq->id); ?>"><?php echo e($eq->nome); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="mb-0">
                                    ...
                                    <div class="d-flex gap-2">
                                        <select id="espelharMes" class="form-select form-select-sm">
                                            ...
                                            <?php for($i = 1; $i <= 12; $i++): ?>
                                                ...
                                                ?>
                                                <option value="<?php echo e($i); ?>" <?php echo e($i == $mesAnterior ? 'selected' : ''); ?>><?php echo e($mesesEspelhar[$i - 1]); ?></option>
                                            <?php endfor; ?>
                                        </select>
                                        <select id="espelharAno" class="form-select form-select-sm" style="width: 90px;">
                                            <?php for($a = date('Y') - 1; $a <= date('Y') + 1; $a++): ?>
                                                ...
                                                ?>
                                                <option value="<?php echo e($a); ?>" <?php echo e($a == $anoAnterior ? 'selected' : ''); ?>><?php echo e($a); ?></option>
                                            <?php endfor; ?>
                                        </select>
                                    </div>
                                </div>
...
<script>
const escalaId = <?php echo e($escala->id); ?>;
const limiteHoras = <?php echo e($limiteHoras); ?>;
const podeEditar = <?php echo e($podeEditar ? 'true' : 'false'); ?>;
const diasNoMes = <?php echo e($diasNoMes); ?>;
const diasInfo = <?php echo json_encode($diasInfo, 15, 512) ?>;
const csrfToken = document.querySelector('meta[name="csrf-token"]').content;
const mesAtual = <?php echo e($mes); ?>;
const anoAtual = <?php echo e($ano); ?>;
...
const todosServidores = <?php echo json_encode($servidores, 15, 512) ?>;
const escalaServidoresData = <?php echo json_encode($escalaServidores, 15, 512) ?>;
const alocacoesData = <?php echo json_encode($alocacoes, 15, 512) ?>;
const todasEquipes = <?php echo json_encode($equipes, 15, 512) ?>;
...
async function removerAlocacaoDia(servidorId, dia, el, horas, abono) {
    ...
    form.append('escala_id', escalaId);
    form.append('servidor_id', servidorId);
    form.append('data', `<?php echo e($ano); ?>-<?php echo e(str_pad($mes, 2, '0', STR_PAD_LEFT)); ?>-${String(dia).padStart(2, '0')}`);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/sigeex-laravel/resources/views/diretor/escala-mensal.blade.php ENDPATH**/ ?>