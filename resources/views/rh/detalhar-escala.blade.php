        ...
        <div class="card p-3">
            <div class="row align-items-center">
                ...
                <div class="col-md-2">
                    ...
                    <h6 class="mb-0">{{ $escala->data_envio ? date('d/m/Y H:i', strtotime($escala->data_envio)) : '-' }}</h6>
                </div>
                @if($escala->data_aprovacao)
                <div class="col-md-2">
                    <small class="text-muted">Data de Aprovação</small>
                    <h6 class="mb-0">{{ date('d/m/Y H:i', strtotime($escala->data_aprovacao)) }}</h6>
                </div>
                @endif
                @if($escala->status === 'executada' && $escala->valor_executado)
                <div class="col-md-2">
                    <small class="text-muted">Valor Executado</small>
                    <h6 class="mb-0 text-success">R$ {{ number_format($escala->valor_executado, 2, ',', '.') }}</h6>
                </div>
                @endif
            ...
            <div class="row mt-2">
                <div class="col-12">
                    ...
                    <span class="text-danger">{{ $escala->motivo_rejeicao }}</span>
                </div>
            </div>
            @endif
        </div>
