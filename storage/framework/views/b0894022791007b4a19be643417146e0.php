            ...
            <div class="text-center flex-fill" style="min-width: 0;">
                <div class="position-relative mx-auto" style="width: 100%; max-width: 60px; height: <?php echo e($alturaMaxima); ?>px;">
                    ...
                    <div class="position-absolute start-0 end-0 d-flex align-items-center justify-content-center" 
                         style="bottom: 0; height: <?php echo e($alturaVerde); ?>px; background-color: #28a745; border-radius: 0 0 0 0; overflow: hidden;"
                         title="Dentro do previsto: R$ <?php echo e(number_format(min($gastoMes, $orcMes), 0, ',', '.')); ?>">
                        <?php if($alturaVerde >= 25): ?>
                        <span class="fw-bold text-white" style="font-size: 11px; writing-mode: vertical-rl; transform: rotate(180deg); white-space: nowrap; text-shadow: 1px 1px 2px rgba(0,0,0,0.5);">
                            <?php echo e(number_format($gastoMes/1000, 1)); ?>k
                        </span>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/diretor/dashboard.blade.php ENDPATH**/ ?>